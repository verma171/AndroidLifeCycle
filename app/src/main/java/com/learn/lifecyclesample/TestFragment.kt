...
class TestFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Util.recLifeCycle(javaClass, LifecycleState.RETURN_FROM_SUPER)
        view.findViewById<TextView>(R.id.title).setText("Activity: ${this.activity?.javaClass?.simpleName} Fragment:${this.javaClass.simpleName}")
        initViews(view)
    }

    private fun initViews(view: View) {
        view.findViewById<Button>(R.id.addFragment).setOnClickListener{
            parentFragmentManager.beginTransaction().apply {
                replace(R.id.container,FragmentA(),FragmentA::class.java.name)
                commit()
            }
        }
        view.findViewById<Button>(R.id.launchActivity).setOnClickListener {
            Intent(this.activity,MainActivityB::class.java).apply {
                startActivity(this)
            }
        }
    }
